<?php namespace App\Module\ThemesManagement\Console\Generators;
...
class MakeTheme extends Command
{
    ...
    private function step1()
    {
        ...
        $this->container['name'] = $this->ask('Name of theme:', 'Ace ' . $this->container['alias']);
        ...
        $this->container['namespace'] = $this->ask('Namespace of theme:', 'App\\Themes\\' . studly_case($this->container['alias']));
