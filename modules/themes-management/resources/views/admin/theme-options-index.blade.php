...
@section('content')
    <div class="layout-2columns sidebar-left">
        <div class="column left">
            <ul class="list-group">
                @php do_action('meta_boxes', 'top-sidebar', 'themes-management.theme-options.index') @endphp
                ...
                @endforeach
                @php do_action('meta_boxes', 'bottom-sidebar', 'themes-management.theme-options.index') @endphp
            </ul>
        </div>
        <div class="column main">
            <div class="tab-content">
                @foreach(cms_theme_options()->export() as $key => $group)
                    ...
                    @endif
                @endforeach
                @php do_action('meta_boxes', 'main', 'themes-management.theme-options.index') @endphp
            </div>
        </div>
    </div>
@endsection
