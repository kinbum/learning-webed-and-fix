<?php namespace App\Module\Base\Http\DataTables;
...
abstract class AbstractDataTables
{
    ...
    protected function view()
    {
        ...
        add_action('footer_js', function () use ($selector, $columns, $ajaxUrl) {
            echo view('base::admin._components.datatables.script-renderer', compact(
                'columns', 'selector', 'ajaxUrl'
            ))->render();
        });
        
        return view('base::admin._components.datatables.table', compact(
