<?php namespace App\Module\Base\Exceptions;
            ...
            switch ($exception->getStatusCode()) {
                ...
                case \Constants::UNAUTHORIZED_CODE:
                    ...
                    if (is_in_dashboard()) {
                        ...
                        return response()->view('base::admin.errors.' . \Constants::UNAUTHORIZED_CODE, [], \Constants::UNAUTHORIZED_CODE);
                    }
                    return response()->view('base::admin.errors.' . \Constants::UNAUTHORIZED_CODE, [], \Constants::UNAUTHORIZED_CODE);
                    break;
                /**
                ...
                case \Constants::FORBIDDEN_CODE:
                    ...
                    if (is_in_dashboard()) {
                        assets_management()->getAssetsFrom('admin');
                        return response()->view('base::admin.errors.' . \Constants::FORBIDDEN_CODE, [], \Constants::FORBIDDEN_CODE);
                    }
                    return response()->view('base::admin.errors.' . \Constants::FORBIDDEN_CODE, [], \Constants::FORBIDDEN_CODE);
                    break;
                /**
                ...
                case \Constants::NOT_FOUND_CODE:
                    ...
                    if (is_in_dashboard()) {
                        assets_management()->getAssetsFrom('admin');
                        return response()->view('base::admin.errors.' . \Constants::NOT_FOUND_CODE, [], \Constants::NOT_FOUND_CODE);
                    }
                    return response()->view('base::admin.errors.' . \Constants::NOT_FOUND_CODE, [], \Constants::NOT_FOUND_CODE);
                    break;
                /**
                ...
                case \Constants::METHOD_NOT_ALLOWED:
                    ...
                    if (is_in_dashboard()) {
                        assets_management()->getAssetsFrom('admin');
                        return response()->view('base::admin.errors.' . \Constants::METHOD_NOT_ALLOWED, [], \Constants::METHOD_NOT_ALLOWED);
                    }
                    return response()->view('base::admin.errors.' . \Constants::METHOD_NOT_ALLOWED, [], \Constants::METHOD_NOT_ALLOWED);
                    break;
                /**
                ...
                case \Constants::ERROR_CODE:
                    ...
                    if (is_in_dashboard()) {
                        assets_management()->getAssetsFrom('admin');
                        return response()->view('base::admin.errors.' . \Constants::ERROR_CODE, [
                            'exception' => $exception
                ...
                case \Constants::MAINTENANCE_MODE:
                    ...
                    if (is_in_dashboard()) {
                        assets_management()->getAssetsFrom('admin');
                        return response()->view('base::admin.errors.' . \Constants::MAINTENANCE_MODE, [], \Constants::MAINTENANCE_MODE);
                    }
                    return response()->view('base::admin.errors.' . \Constants::MAINTENANCE_MODE, [], \Constants::MAINTENANCE_MODE);
                    break;
            }
