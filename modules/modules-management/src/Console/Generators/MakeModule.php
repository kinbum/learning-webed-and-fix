...
class MakeModule extends Command
{
     ...
     * @var string
     */
    protected $description = 'Ace modules generator.';
    ...
    private function step1()
    {
        ...
        $this->container['name'] = $this->ask('Name of module:', 'Ace ' . $this->container['alias']);
        ...
        $this->container['namespace'] = $this->ask('Namespace of module:', 'App\\' . $this->acceptedTypes[$this->moduleType] . '\\' . studly_case($this->container['alias']));
    ...
    private function generatingModule()
    {
         ...
         */
        \File::put($directory . '/module.json', json_encode($this->container, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES));
    }
