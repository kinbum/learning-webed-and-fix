<?php namespace App\Module\ModulesManagement\Support;

use \Closure;
use Illuminate\Support\Collection;
use App\Module\ModulesManagement\Events\ModuleDisabled;
use App\Module\ModulesManagement\Events\ModuleEnabled;
...
class ModulesManagement
{
    ...
    public function modifyModuleAutoload($alias, $isDisabled = false)
    {
         ...
         * Save file
         */
        File::put(base_path('composer.json'), json_encode($composerContent, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES));
