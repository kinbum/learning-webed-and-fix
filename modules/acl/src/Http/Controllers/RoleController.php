...
use App\Module\Acl\Http\DataTables\RolesListDataTable;
use App\Module\Acl\Http\Requests\CreateRoleRequest;
use App\Module\Acl\Http\Requests\UpdateRoleRequest;
...
class RoleController extends BaseAdminController
{
    ...
    public function getIndex(RolesListDataTable $rolesListDataTable)
    {
        ...
        return do_filter('acl-roles.index.get', $this, $rolesListDataTable)->view('roles.index', null, 'admin');
    }
    ...
    public function getCreate(PermissionRepositoryContract $permissionRepository)
    {
        ...
        return do_filter('acl-roles.create.get', $this)->view('roles.create', null, 'admin');
    }
    ...
    public function postCreate(CreateRoleRequest $request)
    {
        ...
        if ($this->request->has('_continue_edit')) {
            return redirect()->to(route('acl-roles.edit.get', ['id' => $result['data']->id]));
        }
    ...
    public function getEdit(PermissionRepositoryContract $permissionRepository, $id)
    {
        ...
        $this->dis['permissions'] = $permissionRepository->orderBy('id', 'ASC')->get();

        return do_filter('acl-roles.edit.get', $this, $id)->view('roles.edit', null, 'admin');
    }
