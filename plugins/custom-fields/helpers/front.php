...
use \App\Plugins\CustomFields\Repositories\Contracts\CustomFieldContract;
...
if (!function_exists('get_field')) {
    ...
    {
        /**
         * @var \App\Plugins\CustomFields\Repositories\CustomFieldRepository $customFieldRepository
         */
