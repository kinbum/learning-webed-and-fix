...
@push('js-include')
    @include('custom-fields::admin._script-templates.edit-field-group-items')
@endpush
...
@section('content')
    {!! Form::open(['class' => 'js-validate-form form-update-field-group', 'url' => route('custom-fields.field-group.edit.post', ['id' => $object->id])]) !!}
    <textarea name="rules"
