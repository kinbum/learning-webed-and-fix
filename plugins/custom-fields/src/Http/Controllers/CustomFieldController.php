<?php namespace App\Plugins\CustomFields\Http\Controllers;

use App\Module\Base\Http\Controllers\BaseAdminController;

use App\Plugins\CustomFields\Http\DataTables\FieldGroupsListDataTable;
use App\Plugins\CustomFields\Http\Requests\CreateFieldGroupRequest;
use App\Plugins\CustomFields\Http\Requests\UpdateFieldGroupRequest;
...
{
    protected $module = 'custom-fields';

    /**
     * @var \App\Plugins\CustomFields\Repositories\FieldGroupRepository
     */
    protected $repository;

    /**
     * @var \App\Plugins\CustomFields\Repositories\FieldItemRepository
     */
    protected $itemRepository;

    public function __construct(FieldGroupRepositoryContract $fieldGroup, FieldItemRepositoryContract $fieldItem)
    {
        parent::__construct();

        $this->getDashboardMenu($this->module);

        $this->breadcrumbs->addLink('Custom fields', route('custom-fields.index.get'));
    ...
    public function getIndex(FieldGroupsListDataTable $fieldGroupsListDataTable)
    {
        ...
        return do_filter('custom-fields.index.get', $this)->view('index', null, 'admin');
    }
    ...
    public function getCreate()
    {
        ...
        return do_filter('custom-fields.create.get', $this)->view('create', null, 'admin');
    }
    ...
    public function postCreate(CreateFieldGroupRequest $request)
    {
        ...
        if ($request->has('_continue_edit')) {
            return redirect()->to(route('custom-fields.field-group.edit.get', ['id' => $result['data']->id]));
        }

        return redirect()->to(route('custom-fields.index.get'));
    }
    ...
    public function getEdit($id)
    {
        ...
        if (!$item) {
            ...
            return redirect()->to(route('custom-fields.field-group.edit.get'));
        }
        ...
        return do_filter('custom-fields.edit.get', $this, $id)->view('edit', null, 'admin');
    }
