...
class BootstrapModuleServiceProvider extends ServiceProvider
{
    ...
    private function booted()
    {
        \DashboardMenu::registerItem([
            ...
            'link' => route('custom-fields.index.get'),
            'css_class' => null,
    ...
    protected function registerUsersFields()
    {
        custom_field_rules()->registerRule('Other', 'Logged in user', 'logged_in_user', function () {
            $userRepository = app(\App\Module\Users\Repositories\Contracts\UserRepositoryContract::class);
            ...
            ->registerRule('Other', 'Logged in user has role', 'logged_in_user_has_role', function () {
                $repository = app(\App\Module\Acl\Repositories\Contracts\RoleRepositoryContract::class);
    ...
    protected function registerPagesFields()
    {
        custom_field_rules()->registerRule('Basic', 'Page template', 'page_template', get_templates('Page'))
            ->registerRule('Basic', 'Page', 'page', function () {
                $pageRepository = $this->app->make(\App\Module\Pages\Repositories\Contracts\PageRepositoryContract::class);
    ...
    {
        if (modules_management()->isActivated('blog') && modules_management()->isInstalled('blog')) {
